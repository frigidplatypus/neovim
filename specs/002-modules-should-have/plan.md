...
**User-provided context**: Module structure follows `config.frgdNeovim.nixvim.{module}.enable` pattern with `mkBoolOpt false` defaults and conditional configuration via `mkIf cfg.enable`.
